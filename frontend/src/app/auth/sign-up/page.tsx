...
export default function SignUp() {
  ...
  const verifyOTPAndCreateAccount = async () => {
    ...
    try {
      ...
      // Use the real mobile registration API
      ...
      // Registration successful, user and tokens are stored by apiService
      // Update auth context state
      if (response.user) {
        // The apiService has already stored the tokens, now we need to update the auth context
        // We can trigger a re-check by reloading the page or calling the auth context directly
        ...
        <Card className="border-gray-200 shadow-xl bg-white">
          <CardHeader className="space-y-2 pb-4">
            ...
            <CardTitle className="text-xl font-bold text-center text-gray-900">
              {currentStep === 1 && "Enter Mobile Number"}
            ...
            {currentStep === 2 && (
              <div className="space-y-4">
                ...
                <div className="flex space-x-2">
                  ...
                  >
                    {isVerifying ? 'Creating Account...' : 'Verify & Sign Up'} 
